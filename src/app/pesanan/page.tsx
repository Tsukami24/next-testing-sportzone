                    ...
                    <select
                      ...
                      onChange={async (e) => {
                        ...
                        const newStatus = e.target
                          .value as import("../services/pesanan-updated").StatusPesanan;
                        ...
                        try {
                          ...
                          const { isPetugas } = await import(
                            "../services/auth"
                          );
                          const petugas = await isPetugas(token);
                          if (!petugas) {
                            alert(
                              "Hanya petugas yang dapat mengubah status pesanan"
                            );
                            return;
                          }
                          await import("../services/pesanan-updated").then(
                            ({ updatePesanan }) =>
                              updatePesanan(token, order.id, {
                                status: newStatus,
                              })
                          );
                          ...
                          const data = await import(
                            "../services/pesanan-updated"
                          ).then(({ getAllPesanan }) => getAllPesanan(token));
                          setPesanan(data);
                        } catch (error: any) {
                          alert(
